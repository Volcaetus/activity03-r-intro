...
**Response**:
lokking at the cololrs nad unbder;line  helped the code corrections
...
**Response**:
orientaions and fforgot a period with df
...
**Response**:
nothing...legnth is correct,.... if this was pyhthon it would need to be reversed
